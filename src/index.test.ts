...
describe('fontColorContrast', () => {
  ...
  test('black font to light pink background', () => {
    const font = fontColorContrast(colors.lightPink)
    expect(font).toBe('#000000')
  })

  test('white font to pink background', () => {
  ...
  test('white font to strange grey background', () => {
    const font = fontColorContrast(colors.strangeGrey)
    expect(font).toBe('#ffffff')
  })

  test('white font to notColor1', () => {
    const font = fontColorContrast(colors.notColor1)
    expect(font).toBe('#ffffff')
  })

  test('white font to notColor2', () => {
    const font = fontColorContrast(colors.notColor2 as unknown as string)
    expect(font).toBe('#ffffff')
  })

  test('black font to light green background', () => {
    const font = fontColorContrast(colors.lightGreen)
    expect(font).toBe('#000000')
  })

  test('black font to pale yellow background', () => {
    const font = fontColorContrast(
  ...
  test('white font to dark blue', () => {
    const font = fontColorContrast(colors.darkBlue)
    expect(font).toBe('#ffffff')
  })
})
